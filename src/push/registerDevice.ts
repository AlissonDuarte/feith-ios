/**
 * Registro do aparelho no APNs.
 *
 * A web pede uma PushSubscription ao service worker e manda endpoint + chaves
 * VAPID para /api/push/subscribe (front_fide/src/lib/pushNotifications.js).
 * Web Push nao existe em app nativo iOS: aqui o sistema devolve um device token
 * opaco, que vai para /api/push/device. Sao dois protocolos e dois endpoints; o
 * backend decide qual usar por usuario.
 *
